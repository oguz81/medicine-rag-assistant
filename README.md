...
This project is still being developed as web and mobile application. When it's ready, you can access to the app to ask about medicines.

## Backend 
Built with ChromaDB, FastAPI, Uvicorn and gpt-4o-mini from OpenAI as LLM model.
## Frontend
...
Uygulama web ve mobilde kullanılacak şekilde geliştirilmektedir. Kullanıma hazır olduğunda çevrimiçi olarak erişilebilecektir.
